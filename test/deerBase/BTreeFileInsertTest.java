...
public class BTreeFileInsertTest extends DeerBaseTestBase {
	...
	public void testSplitLeafPages() throws Exception {
		...
		System.out.println("leftPage.getNumEntries() :" + leftPage.getNumTuples());
		...
		System.out.println("entriesPerPage :" + BTreeUtility.getNumTuplesPerPage(2));
		System.out.println("page.getNumEntries() :" + page.getNumTuples());
		System.out.println("otherPage.getNumEntries() :" + otherPage.getNumTuples());
