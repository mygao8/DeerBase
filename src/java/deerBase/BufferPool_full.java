...
public class BufferPool_full {
     ...
     */
    public BufferPool_full(int numPages) {
    	this.numPages = numPages;
    	this.numUsedPages = 0;
    	this.pageMap = new LRUCache(numPages);
    }

    public BufferPool_full(int numPages, float loadTableRatio) {
    	this(numPages);
    	BufferPool_full.loadTableRatio = loadTableRatio;
    }
    ...
    public static void setPageSize(int pageSize) {
    	BufferPool_full.pageSize = pageSize;
    }
    
    // Only used for testing
    public static void resetPageSize() {
    	BufferPool_full.pageSize = DEFAULT_PAGE_SIZE;
    }
