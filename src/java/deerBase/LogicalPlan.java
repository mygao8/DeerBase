...
//    private Query owner;
    ...
    */
    ...
    /** Add an aggregate over the field with the specified grouping to
        the query.  DeerBase only supports a single aggregate
    ...
    */
    ...
    /** Add an ORDER BY expression in the specified order on the specified field.  DeerBase only supports
    ...
    */
    ...
    String disambiguateName(String name) throws ParsingException {
        ...
        while (tableIt.hasNext()) {
            ...
            try {
                TupleDesc td = ((HeapFile) Database.getCatalog().getDbFile(table.t)).getTupleDesc();
    ...
    public DbIterator physicalPlan(TransactionId t, Map<String,TableStats> baseTableStats, boolean explain) throws ParsingException {
        ...
        while (tableIt.hasNext()) {
            ...
            SeqScan ss = null;
            try {
                 ss = new SeqScan(t, Database.getCatalog().getDbFile(table.t).getFileId(), table.alias);
            } catch (NoSuchElementException e) {
