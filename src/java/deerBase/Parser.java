...
public class Parser {
    ...
    public static Predicate.Op getOp(String s) throws deerBase.ParsingException {
        if (s.equals("="))
            ...
            if (isJoin) { // join node
                ...
                if (!op2const) { // right op is a nested query
                    try {
                        ...
                        throw new deerBase.ParsingException("Invalid subquery "
                                + ops.elementAt(1));
    ...
    public LogicalPlan parseQueryLogicalPlan(TransactionId tid, ZQuery q)
            throws IOException, Zql.ParseException, deerBase.ParsingException {
        @SuppressWarnings("unchecked")
        ...
        for (int i = 0; i < from.size(); i++) {
            ...
            try {
                ...
                e.printStackTrace();
                throw new deerBase.ParsingException("Table "
            ...
            if (si.getAggregate() != null) {
                ...
                if (groupByField != null
                        && !(groupByField.equals(si.getTable() + "."
                                ...
                                .getColumn()))) {
                    throw new deerBase.ParsingException("Non-aggregate field "
                            + si.getColumn()
        ...
        if (groupByField != null && aggFun == null) {
            throw new deerBase.ParsingException("GROUP BY without aggregation.");
        }
    ...
    public Query handleQueryStatement(ZQuery s, TransactionId tId)
            ...
            deerBase.ParsingException, Zql.ParseException {
        ...
        if (physicalPlan != null) {
            Class<?> c;
            try {
                c = Class.forName("deerBase.OperatorCardinality");
                ...
                c = Class.forName("deerBase.QueryPlanVisualizer");
                m = c.getMethod(
    ...
    public Query handleInsertStatement(ZInsert s, TransactionId tId)
        ...
        try {
            ...
            throw new deerBase.ParsingException("Unknown table : "
                    + s.getTable());
        }
            ...
            for (ZExp e : values) {
                ...
                if (zc.getType() == ZConstant.NUMBER) {
                    if (td.getFieldType(i) != Type.INT_TYPE) {
                        throw new deerBase.ParsingException("Value "
                                + zc.getValue()
    ...
    public void handleTransactStatement(ZTransactStmt s)
        ...
        if (s.getStmtType().equals("COMMIT")) {
            ...
            throw new deerBase.ParsingException("Unsupported operation");
        }
    }
    ...
    public LogicalPlan generateLogicalPlan(TransactionId tid, String s)
        ...
        try {
            ...
            throw new deerBase.ParsingException(e);
        }
        ...
        try {
            ...
            if (s instanceof ZTransactStmt)
                ...
                try {
                    ...
                    if (a instanceof deerBase.ParsingException
            ...
            e.printStackTrace();
        } catch (deerBase.ParsingException e) {
            System.out
    ...
    protected void start(String[] argv) throws IOException {
        ...
        if (!interactive) {
            ...
            String line;
            boolean quit = false;
            while (!quit && (line = reader.readLine("DeerBase> ")) != null) {
